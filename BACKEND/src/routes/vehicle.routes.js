...
router.post('/create', vehicleMiddleware.validateVehicle(), vehicleController.create.bind(vehicleController));
...
router.put('/:id/update', vehicleMiddleware.validateVehicle(), vehicleController.update.bind(vehicleController));
